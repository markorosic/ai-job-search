% !TeX recipe = Tectonic
% CV - Marko Rosic - tailored for Dash0, Director of Design (EMEA Remote)
% Compile with: cd cv && tectonic Marko_Rosic_CV_dash0.tex
...
% ── Skill block: use \newline not \\ to avoid tabular row-break bug ───
...
{\small Product design leader with 15+ years building complex digital
products at the intersection of design and engineering. I build design
systems that hold up as products grow, from token architecture and
multi-brand component libraries to handoff that engineers actually
use, and have cut development time by 30\% and time-to-market by 25\%.
I lead design teams in fast-moving product companies and I work best
close to engineering: designing information-dense interfaces for
technical users and staying involved in how things are actually built.
I use AI (including Claude Code) to build faster and to understand
...
\begin{cvitems}
  \item Senior design lead across several engagements at once, advising
        product and media companies on design systems, product strategy,
        and how design and engineering work together
  ...
  \item Lead AI\-orchestrated product and tooling work, owning the
        problem, the UX, and the research direction while using Claude
...
\begin{cvitems}
  \item Set design direction and standards across multi-brand products
        through a company-wide design system
  \item Led a design team of seven, managing two team leads who each
        ran their own sub-team, and owning their direction, growth,
        and performance
  \item Changed how the team worked, cutting time-to-market for new
        features by 25\%
  \item Worked closely with engineering so design fit into how they
        build
  \item Used analytics and user feedback to keep improving the product
\end{cvitems}
...
\begin{cvitems}
  ...
  \item Built a design system for the flagship consumer product that
        ...
        websites
  \item Ran workshops with stakeholders to line up design decisions
        with business goals
...
\begin{cvitems}
  \item Co-founded a dial-up ISP; led operations, finance, and product
        design during the founding phase. The company later evolved
        into managed hosting and cloud services
\end{cvitems}
