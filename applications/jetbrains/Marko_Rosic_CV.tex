...
\begin{cvitems}
  \item Design-leadership consulting with AI-augmented delivery as the
        operating model — using Claude Code to build Figma plugins,
        automate design tasks, and ship working artefacts end to end
  \item Architected a Figma-to-production pipeline: design tokens flow
        directly from Figma to theme tokens in code (block-based theme),
        giving design and engineering a single source of truth
  \item Defined architecture and wrote PRDs for an AI-orchestrated
        data-intelligence platform: URL discovery, crawling, and
        automated ingestion pipelines built with AI agents
  \item Led end-to-end product UX for a 0→1 consumer platform:
        retention flows, progressive filter architecture, conversion
        optimisation
\end{cvitems}
