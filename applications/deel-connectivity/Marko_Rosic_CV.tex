% !TeX recipe = Tectonic
% CV - Marko Rosic - tailored for Deel, Lead Product Designer - Connectivity
% Compile with: cd cv && tectonic Marko_Rosic_CV_deel_connectivity.tex
...
{\small Product designer and team lead with 15+ years at the
intersection of design and engineering. I build design systems for
complex, multi-brand products and work best where design meets the
engineering layer, through Figma plugins, working prototypes, and
close collaboration with engineers on how interfaces get built. I
lead small teams by doing the work alongside them and I use AI
(including Claude Code) to build faster and to stay close to how
...
\begin{cvitems}
  \item Design-leadership consulting — owning design strategy, design
        systems, and design-engineering workflow with AI-augmented
        delivery (Claude Code) as the operating model
  \item Architected a token-based design system for a multi-product
  ...
  \item Designed complex information architecture for a consumer
        platform: progressive filter refinement, multi-level category
        browsing, and a UI component system for content status states
  \item Built Figma plugins and AI-orchestrated workflows to accelerate
        design-to-development cycles
\end{cvitems}
